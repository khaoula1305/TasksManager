...
namespace TaskManager.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected RadzenDataGrid<TaskManager.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(TaskManager.Server.Models.ApplicationRole role)
        {
            try
            {
