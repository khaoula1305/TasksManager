...
namespace TaskManager.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<TaskManager.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<TaskManager.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(TaskManager.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(TaskManager.Server.Models.ApplicationUser user)
        {
            try
            {
