...
{
    public partial class EditTaskHistory
    {
        [Inject]
        ...
        {
            taskHistory = await TaskManagerDbService.GetTaskHistoryByHistoryId(historyId:HistoryID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await TaskManagerDbService.UpdateTaskHistory(historyId:HistoryID, taskHistory);
