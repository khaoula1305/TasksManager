...
{
    public partial class EditTaskSubPoint
    {
        [Inject]
        ...
        {
            taskSubPoint = await TaskManagerDbService.GetTaskSubPointBySubPointId(subPointId:SubPointID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await TaskManagerDbService.UpdateTaskSubPoint(subPointId:SubPointID, taskSubPoint);
